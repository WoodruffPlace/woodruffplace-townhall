<div class="text-secondary">
	<span class="bi bi-circle-fill <?php echo Request::status_display($request->request_get('status'))['color-text']; ?> me-1"></span> <span class="fw-medium fs-7 text-secondary-emphasis"><?php echo Request::status_display($request->request_get('status'))['status']; ?>
	<?php
