<div class="text-secondary">
	<span class="d-block fs-7">Request status:</span><span class="bi bi-circle-fill <?php echo $request->status_display()['color-text']; ?> me-1"></span> <span class="fw-medium fs-7 text-secondary-emphasis"><?php echo $request->status_display()['status']; ?>
	<?php
