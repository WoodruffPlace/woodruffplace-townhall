...
class Messages
{
	...
	public static function customer_upcoming_event_notification($request, $customer)
	{
		...
		$message .= "\n\n";
		$message .= "2) WiFi is free to use. The network name is \"TownHall\" and the password is: 1872Woodruff";
		$message .= "\n\n";
		$message .= "3) The chair cart is in the main room and the tables are in the closet located in the back corner of the main room.";
		$message .= "\n\n";
		$message .= "4) There is a Nest thermostat for the main room located on the stage. Please note that it is a commercial system and requires more time to heat and cool than a typical house.";
		$message .= "\n\n";
		$message .= "5) The speaker on the stage is available for use and can pair via Bluetooth to your personal device.";
		$message .= "\n\n";
		$message .= "6) The stage lights are controlled by the small mixing board on the floor next to the speaker. Slide channel one to your color preference.";
		$message .= "\n\n";
		$message .= "7) Cleaning supplies and some consumables can be found in the small room to the north (stage right) of the main stage.";
		$message .= "\n\n";
		$message .= "8) Consumables like trash bags, disposable utensils/plates/cups may be found in the kitchen, stage left.";
		$message .= "\n\n\n";
		//$message .= "8)All rental-related tasks are noted in the original contract checklist, 	.";
		$message .= "IMPORTANT\n\n";
		$message .= "As part of your rental contract, you are required to complete the closing checklist, the link to which is below. The checklist must be completed within *". $GLOBALS['settings']->get('request.checklist_due')."* days of the final rental session in order to obtain your security deposit back. If you will not be present during clean-up, please forward this to those who will so they may submit the checklist on your behalf.";
		$message .= "\n\n";
